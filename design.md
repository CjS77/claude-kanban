...
The design record for v1: what was decided, why, and which properties of the implementation are load-bearing. For installation and usage, see the [README](README.md).
