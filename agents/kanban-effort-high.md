---
name: kanban-effort-high
description: Works a single Kanban ticket at high reasoning effort. Launched by /kanban:work for tickets whose card asks for `effort: high`; not meant to be selected on your own judgement.
effort: high
model: inherit
---
