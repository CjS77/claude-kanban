---
name: kanban-effort-xhigh
description: Works a single Kanban ticket at xhigh reasoning effort. Launched by /kanban:work for tickets whose card asks for `effort: xhigh`; not meant to be selected on your own judgement.
effort: xhigh
model: inherit
---
