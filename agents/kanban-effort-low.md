---
name: kanban-effort-low
description: Works a single Kanban ticket at low reasoning effort. Launched by /kanban:work for tickets whose card asks for `effort: low`; not meant to be selected on your own judgement.
effort: low
model: inherit
---
